...
interface ProductItemsTableProps {
  items: ProductItem[];
  /** Heading shown above the table (e.g. the sub-product name). */
  title: string;
  eyebrow?: string;
}

/**
 * The product catalog table used on sub-product pages, and inline on a
 * category page when that category has a single sub-product.
