    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-maxx-300 mt-1">Manage news articles and events</p>
        </div>
        <Link
          href="/admin/news/new"
      ...
      <div className="bg-maxx-900 border border-maxx-700 rounded-xl overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 text-center">
            <p className="text-maxx-300 mb-4">No articles found</p>
            <Link href="/admin/news/new" className="text-maxx-accent hover:text-maxx-mint">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-maxx-700 bg-maxx-800/50">
                ...
                <th className="text-left px-6 py-4 text-sm font-semibold text-maxx-200">Date</th>
