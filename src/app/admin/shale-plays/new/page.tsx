...
export default function NewShalePlayPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch("/api/shale-plays", {
      method: "POST",
    ...
    if (response.ok) {
      ...
      alert(error.error || "Failed to create shale play");
    }
  ...
  return (
    <div>
      <div className="flex items-center space-x-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">New Shale Play</h1>
          <p className="text-maxx-300 mt-1">Add a new shale play region</p>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <span>{saving ? "Saving..." : "Save Shale Play"}</span>
            </motion.button>
          </div>
        </div>
      </form>
